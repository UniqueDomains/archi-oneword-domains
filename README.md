...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C603%20rows-8250df">
...
Daily-updated dataset of available and resale .archi one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Live product counts can still change as the search refreshes.

**Public extract:** 9,603 rows · **Live catalog:** 9,603 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/archi?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_archi_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/archi?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_archi_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./archi.csv">CSV</a> / <a href="./archi.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_archi_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_archi_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .ARCHI search](https://unique.domains/domains/tld/archi?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_archi_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .ARCHI search](https://unique.domains/domains/tld/archi?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_archi_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./archi.csv) or [Download JSON](./archi.json)
...
- `archi.csv` — public CSV extract (9,603 rows)
- `archi.json` — public JSON extract (9,603 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,603-row public sample | 9,603 live domains                               |
...
| event.archi        | available | $132.98   | —             | 96             | 48     | 5      | namecheap           |
